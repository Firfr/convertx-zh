...
- 国内仓库
  - AMD64镜像
    ```bash
    swr.cn-north-4.myhuaweicloud.com/firfe/convertx-zh:0.17.0
    ```
  - ARM64镜像
    ```bash
    swr.cn-north-4.myhuaweicloud.com/firfe/convertx-zh:0.17.0-arm64
    ```
- DockerHub仓库
  - AMD64镜像
    ```bash
    firfe/convertx-zh:0.17.0
    ```
  - ARM64镜像
    ```bash
...
services:
  convertx-zh:
    ...
    image: swr.cn-north-4.myhuaweicloud.com/firfe/convertx-zh:0.17.0
    network_mode: bridge
    restart: always
    logging:
      options:
